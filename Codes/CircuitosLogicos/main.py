...
class CircuitosLogicosWidget(BoxLayout):

    def __init__(self, **kwargs):
        super(CircuitosLogicosWidget, self).__init__(**kwargs)
        self.orientation = "vertical"
...
class CircuitosLogicosApp(App):
    def build(self):
        root = CircuitosLogicosWidget()
        return root


if __name__ == "__main__":
    CircuitosLogicosApp().run()
